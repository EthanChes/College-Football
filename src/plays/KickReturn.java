...
public class KickReturn {
    ...
    private List<DefensiveBack> defensiveBacks;
        ...
        public KickReturn(float ballX, float ballY) {
            ...
            defensiveBacks.add(new DefensiveBack(new Transform(ballX + 2, ballY - 3)));
            ...
            defensiveBacks.add(new DefensiveBack(new Transform(ballX + 42, ballY - 6)));
            defensiveBacks.get(0).setDefenderID(-1,defensiveBacks.get(5));
            defensiveBacks.get(5).uniqueEvents = true;
            defensiveBacks.add(new DefensiveBack(new Transform(ballX + 42, ballY - 3)));
            defensiveBacks.get(0).setDefenderID(-1,defensiveBacks.get(6));
            defensiveBacks.get(6).uniqueEvents = true;
            defensiveBacks.add(new DefensiveBack(new Transform(ballX + 52, ballY)));
            ...
            defensiveBacks.add(new DefensiveBack(new Transform(ballX + 122, ballY)));
