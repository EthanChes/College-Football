...
public class Kickoff {
    private List<Entity> entities;
        ...
        public Kickoff(float ballX, float ballY) {
            ...
            entities.add(new RunningBack(new Transform(ballX,ballY + 4)));
            entities.get(2).uniqueEvents = true;
            entities.get(2).setRoute(0);
            entities.add(new RunningBack(new Transform(ballX,ballY + 6)));
            ...
            entities.add(new RunningBack(new Transform(ballX,ballY + 10)));
